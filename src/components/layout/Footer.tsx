...
const Footer = () => {
  ...
  const serviceLinks = [
    { name: '포트폴리오 최적화', path: '/services/portfolio-optimization' },
    { name: '위험 관리', path: '/services/risk-management' },
    { name: '자산 배분', path: '/services/asset-allocation' },
    { name: '퀀트 전략', path: '/services/quant-strategy' }
  ];
  ...
  const legalLinks = [
    ...
    { name: '쿠키 정책', path: '/services/cookie-policy' }
  ];
